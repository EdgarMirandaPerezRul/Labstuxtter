...
ejercicios=
    "1. Muestra el directorio actual del usuario."     
    "2. Crea la carpeta dir1 y muestra el resultado deasead."     
    "3. Crea la carpeta dir2 y muestra el resultado  deseado."     
    "4. Crea la carpeta dir3 dentro de dir2 y muestra el resultado."     
    "5. Crea la carpeta dir4 dentro de dir3 y muestra el resultado xd."     
    "6. Liste el contenido."     
    "7. Lista todos los archivos en forma recursiva."     
    "8. Cambiarse a la carpeta dir2."     
    "9. Regresa a la carpeta anterior."     
    "10. Cambiate a la carpeta home ."     
